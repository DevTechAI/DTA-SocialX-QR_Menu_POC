...
export default function BookCoworkSeatPage() {
  ...
  return (
    <main className="min-h-screen gradient-soft flex flex-col items-center justify-center w-full p-4">
      <div className="w-full max-w-2xl text-center">
        {/* Icon */}
        <div className="inline-flex items-center justify-center w-24 h-24 rounded-2xl bg-gradient-to-br from-green-500 to-green-600 mb-6 shadow-soft-lg">
        ...
        <div className="bg-white rounded-2xl shadow-soft-lg p-8 mb-6">
          ...
          <p className="text-gray-500 mb-6">
            We&apos;re working hard to bring you the co-working seat booking system. 
            Check back soon!
          </p>
