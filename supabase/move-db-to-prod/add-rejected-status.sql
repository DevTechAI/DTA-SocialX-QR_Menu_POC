...
-- ============================================
-- This migration adds "rejected" as a valid status option
...
ALTER TABLE orders 
  ...
  CHECK (status IN ('received', 'accepted', 'rejected', 'delivered', 'paid', 'unpaid'));
...
-- 2. Try updating an order status to "rejected"
